...
static constexpr auto qt_meta_stringdata_CLASSVolumeENDCLASS = QtMocHelpers::stringData(
    "Volume",
    "changed",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSVolumeENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSVolumeENDCLASS_t qt_meta_stringdata_CLASSVolumeENDCLASS = {
    {
...
void Volume::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Volume::*)();
            if (_t _q_method = &Volume::changed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }

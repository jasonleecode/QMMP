...
#include "../../../../../../../src/plugins/Transports/http/httpinputfactory.h"
...
struct qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS = QtMocHelpers::stringData(
    "HTTPInputFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS_t qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16)   // "HTTPInputFactory"
    },
    "HTTPInputFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHTTPInputFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject HTTPInputFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSHTTPInputFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<HTTPInputFactory, std::true_type>
    >,
    nullptr
} };
...
void *HTTPInputFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHTTPInputFactoryENDCLASS.stringdata0))

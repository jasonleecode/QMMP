...
#include "../../../../../../../src/plugins/Effect/ladspa/effectladspafactory.h"
...
struct qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS = QtMocHelpers::stringData(
    "EffectLADSPAFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS_t qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 19)   // "EffectLADSPAFactory"
    },
    "EffectLADSPAFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEffectLADSPAFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject EffectLADSPAFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEffectLADSPAFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<EffectLADSPAFactory, std::true_type>
    >,
    nullptr
} };
...
void *EffectLADSPAFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEffectLADSPAFactoryENDCLASS.stringdata0))

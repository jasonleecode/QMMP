...
#include "../../../../../../../src/plugins/General/udisks/udisksmanager.h"
...
struct qt_meta_stringdata_CLASSUDisksManagerENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSUDisksManagerENDCLASS = QtMocHelpers::stringData(
    "UDisksManager",
    "deviceAdded",
    "",
    "QDBusObjectPath",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSUDisksManagerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSUDisksManagerENDCLASS_t qt_meta_stringdata_CLASSUDisksManagerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "UDisksManager"
        QT_MOC_LITERAL(14, 11),  // "deviceAdded"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 15),  // "QDBusObjectPath"
        QT_MOC_LITERAL(43, 13),  // "deviceRemoved"
        QT_MOC_LITERAL(57, 17),  // "onInterfacesAdded"
        QT_MOC_LITERAL(75, 11),  // "object_path"
        QT_MOC_LITERAL(87, 14),  // "QVariantMapMap"
        QT_MOC_LITERAL(102, 19)   // "onInterfacesRemoved"
    },
    "UDisksManager",
    "deviceAdded",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUDisksManagerENDCLASS[] = {
 ...
 // slots: parameters
    QMetaType::Void, 0x80000000 | 3, 0x80000000 | 7,    6,    2,
    QMetaType::Void, 0x80000000 | 3, QMetaType::QStringList,    6,    2,
...
Q_CONSTINIT const QMetaObject UDisksManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSUDisksManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUDisksManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUDisksManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UDisksManager, std::true_type>,
        // method 'deviceAdded'
        ...
        QtPrivate::TypeAndForceComplete<const QVariantMapMap &, std::false_type>,
...
void UDisksManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UDisksManager::*)(QDBusObjectPath );
            if (_t _q_method = &UDisksManager::deviceAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UDisksManager::*)(QDBusObjectPath );
            if (_t _q_method = &UDisksManager::deviceRemoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *UDisksManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSUDisksManagerENDCLASS.stringdata0))

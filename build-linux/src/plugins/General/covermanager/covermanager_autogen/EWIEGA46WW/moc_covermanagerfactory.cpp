...
#include "../../../../../../../src/plugins/General/covermanager/covermanagerfactory.h"
...
struct qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS = QtMocHelpers::stringData(
    "CoverManagerFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS_t qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 19)   // "CoverManagerFactory"
    },
    "CoverManagerFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCoverManagerFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CoverManagerFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCoverManagerFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CoverManagerFactory, std::true_type>
    >,
    nullptr
} };
...
void *CoverManagerFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCoverManagerFactoryENDCLASS.stringdata0))

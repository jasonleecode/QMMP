...
#include "../../../../../../../src/plugins/General/history/historyfactory.h"
...
struct qt_meta_stringdata_CLASSHistoryFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSHistoryFactoryENDCLASS = QtMocHelpers::stringData(
    "HistoryFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSHistoryFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSHistoryFactoryENDCLASS_t qt_meta_stringdata_CLASSHistoryFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14)   // "HistoryFactory"
    },
    "HistoryFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHistoryFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject HistoryFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSHistoryFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSHistoryFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHistoryFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<HistoryFactory, std::true_type>
    >,
    nullptr
} };
...
void *HistoryFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHistoryFactoryENDCLASS.stringdata0))

...
#include "../../../../../../../src/plugins/General/sleepinhibitor/sleepinhibitorfactory.h"
...
struct qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS = QtMocHelpers::stringData(
    "SleepInhibitFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS_t qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 19)   // "SleepInhibitFactory"
    },
    "SleepInhibitFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSleepInhibitFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SleepInhibitFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSleepInhibitFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SleepInhibitFactory, std::true_type>
    >,
    nullptr
} };
...
void *SleepInhibitFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSleepInhibitFactoryENDCLASS.stringdata0))

...
#include "../../../../../../../src/plugins/General/streambrowser/streambrowserfactory.h"
...
struct qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS_t qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 20)   // "StreamBrowserFactory"
    },
    "StreamBrowserFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStreamBrowserFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StreamBrowserFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStreamBrowserFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<StreamBrowserFactory, std::true_type>
    >,
    nullptr
} };
...
void *StreamBrowserFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStreamBrowserFactoryENDCLASS.stringdata0))

...
#include "../../../../../../../src/plugins/General/mpris/mprisfactory.h"
...
struct qt_meta_stringdata_CLASSMPRISFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSMPRISFactoryENDCLASS = QtMocHelpers::stringData(
    "MPRISFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMPRISFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMPRISFactoryENDCLASS_t qt_meta_stringdata_CLASSMPRISFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12)   // "MPRISFactory"
    },
    "MPRISFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMPRISFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MPRISFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMPRISFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMPRISFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMPRISFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MPRISFactory, std::true_type>
    >,
    nullptr
} };
...
void *MPRISFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMPRISFactoryENDCLASS.stringdata0))

...
#include "../../../../../../../src/plugins/Output/null/outputnullfactory.h"
...
struct qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS = QtMocHelpers::stringData(
    "OutputNullFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS_t qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 17)   // "OutputNullFactory"
    },
    "OutputNullFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOutputNullFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OutputNullFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOutputNullFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OutputNullFactory, std::true_type>
    >,
    nullptr
} };
...
void *OutputNullFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOutputNullFactoryENDCLASS.stringdata0))

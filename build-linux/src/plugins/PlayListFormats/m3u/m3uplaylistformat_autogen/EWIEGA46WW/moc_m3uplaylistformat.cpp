...
#include "../../../../../../../src/plugins/PlayListFormats/m3u/m3uplaylistformat.h"
...
struct qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS = QtMocHelpers::stringData(
    "M3UPlaylistFormat"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS_t qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS = {
    {
        QT_MOC_LITERAL(0, 17)   // "M3UPlaylistFormat"
    },
    "M3UPlaylistFormat"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSM3UPlaylistFormatENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject M3UPlaylistFormat::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSM3UPlaylistFormatENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<M3UPlaylistFormat, std::true_type>
    >,
    nullptr
} };
...
void *M3UPlaylistFormat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSM3UPlaylistFormatENDCLASS.stringdata0))

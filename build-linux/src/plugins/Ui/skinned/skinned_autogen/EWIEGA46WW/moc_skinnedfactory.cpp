...
#include "../../../../../../../src/plugins/Ui/skinned/skinnedfactory.h"
...
struct qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS = QtMocHelpers::stringData(
    "SkinnedFactory"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS_t qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14)   // "SkinnedFactory"
    },
    "SkinnedFactory"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSkinnedFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SkinnedFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSkinnedFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SkinnedFactory, std::true_type>
    >,
    nullptr
} };
...
void *SkinnedFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSkinnedFactoryENDCLASS.stringdata0))
